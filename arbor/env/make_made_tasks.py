...
생성해 data/made/ 에 저장한다. 셀 목록으로만 격자를 짜서(하드코딩 오류 방지)
JSON 으로 굳힌다.
...
run:  python3 -m arbor.env.make_made_tasks
"""
...
DATA = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "data", "made")
