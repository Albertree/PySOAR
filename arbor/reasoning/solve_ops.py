...
from arbor.perception.select_solver import fg_objects                      # 전경 object 추출(predefined)
from procedural_memory.dsl.helpers import (context, grid_bg, ranked_hypotheses,      # predefined DSL 기계
                     build_from_hypothesis)
from arbor.expr_solver import _lone, _target_and_others, _pick_target
from arbor.reasoning import relation_solve                                 # structure-mapping 관계 일반화
...
def _op_find(ag):
    ...
    from arbor.solver import _focus, _siblings
